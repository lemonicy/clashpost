...
<Table class="cp-table-with-all-borders cp-table-without-hover-bg" maxWidth="800px">
    <table>
        ...
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/6540/Icon_League_King.png" width="166" height="166" alt="联赛蛮王" />
            </td>
            <td>联赛蛮王</td>
            <td>
        ...
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/6540/Icon_League_Queen.png" width="166" height="166" alt="联赛女皇" />
            </td>
            <td>联赛女皇</td>
            <td>
                <a href="/p/6540">英雄皮肤</a>
        ...
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/6540/Icon_League_Warden.png" width="166" height="166" alt="联赛守护者" />
            </td>
            <td>联赛守护者</td>
            <td>
                <a href="/p/6540">英雄皮肤</a>
        ...
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/6540/Icon_League_Champion.png" width="166" height="166" alt="联赛战神" />
            </td>
            <td>联赛战神</td>
            <td>
                <a href="/p/6540">英雄皮肤</a>
