...
lastUpdated: 2026-01-21T14:37:15+08:00
tags: announcement
---

<PostHistory>
2026-01-21 修订：更新最新的浏览器下载地址。<br>
2025-10-16 修订：完善细节。<br>
2025-09-13 修订：添加一些注意事项。
</PostHistory>
...
- 如果你是 Android 系统，并且使用的是轻量级浏览器（如 Via 浏览器），请通过后文的下载地址更新这两个组件：
  ...
  - Android System Webview 组件（所有版本都需要）
...
官方渠道有保障，下载速度快，**无需翻墙**，且没有乱七八糟的注意事项，推荐大多数人选用。遗憾的是，如果你是 Android 手机，则需要 [谷歌三件套](/p/6844) 才能下载。
...
如果你因为种种原因无法使用官方链接，那非常遗憾，你需要阅读这一大堆注意事项了。

- 除官方链接外，网站内的下载链接不会第一时间更新，因此很可能不是最新版本，但我们能保证我们提供的版本一定不会太旧。
- 除官方链接外，网站内的安装包不考虑安卓模拟器，模拟器可以尝试安装，但不保证能用。
- 本文仅提供 Android 7.0+ 和 Windows 10+ 的安装包，其他系统请寻找其他渠道下载。
- **从 Android 10 开始，手动安装 Chrome 比较麻烦，安装前请先做这些准备工作：**
  - 如果你之前从未手动下载过 Chrome，请先在应用管理中卸载 Chrome 和 Android Webview 更新。该操作只需做一次，下次下载时可跳过。
  - 如果你是小米手机，请 [关闭系统优化（MIUI 优化）](/p/6866)。
...
- [Trichrome Library 144 版本（Android 10+）](https://www.apkmirror.com/apk/google-inc/trichrome-library/trichrome-library-144-0-7559-76-release/trichrome-library-144-0-7559-76-7-android-apk-download/)
- [Chrome 144 版本（Android 10+）](https://www.apkmirror.com/apk/google-inc/chrome/google-chrome-144-0-7559-76-release/google-chrome-144-0-7559-76-14-android-apk-download/)
  - 这个安装包比较特殊，需要使用这篇文章提到的安装工具安装：[如何安装 xapk 或 apkm 格式的安装包？](/p/6665)
- [Android System Webview 144 版本（Android 12L+）](https://www.apkmirror.com/apk/google-inc/android-system-webview/android-system-webview-144-0-7559-76-release/android-system-webview-144-0-7559-76-3-android-apk-download/)
  - 目前暂未找到适合 Android 10 和 Android 11 且版本相同的 Webview.

如果实在安装不上，请尝试安装针对 Android 8 - 9 的 138 版本。这是最后手段，不建议使用。

如果你喜欢 Firefox 浏览器，也可以把这个装上：

- [Firefox 147 版本（Android 8.0+）](https://www.apkmirror.com/apk/mozilla/firefox/firefox-fast-private-browser-147-0-1-release/firefox-fast-private-browser-147-0-1-6-android-apk-download/)
...
- [Firefox 143 版本（Android 5.0+）](https://www.apkmirror.com/apk/mozilla/firefox/firefox-fast-private-browser-143-0-4-release/firefox-fast-private-browser-143-0-4-2-android-apk-download/)
...
- [Trichrome Library 144 版本（Android 10+）](https://static.clashpost.com/download/browser/Trichrome_Library_v144_Android_10_pqyngtRfa02dR2iz.apk)
- [Chrome 144 版本（Android 10+）](https://static.clashpost.com/download/browser/Chrome_Android_v144_Android_10_8qE5ENBXBwv6Ip0k.apkm)
  - 这个安装包比较特殊，需要使用这篇文章提到的安装工具安装：[如何安装 xapk 或 apkm 格式的安装包？](/p/6665)
- [Android System Webview 144 版本（Android 12L+）](https://static.clashpost.com/download/browser/Android_Webview_v144_Android_12L_DohkcrKyEv0SSl5M.apk)
  - 目前暂未找到适合 Android 10 和 Android 11 且版本相同的 Webview.
...
- [Firefox 147 版本（Android 8.0+）](https://static.clashpost.com/download/browser/Firefox_Android_v147_Qv7LbDvyRWP9uMV6.apk)
...
- [Firefox 143 版本（Android 5.0+）](https://static.clashpost.com/download/browser/Firefox_Android_v143_jgIoZb1Ftf8AT7fM.apk)
...
- [Chrome 144 版本 (Windows 10/11)](https://static.clashpost.com/download/browser/Chrome_Windows_v144_n9gTdKCRuMuDiYme.exe)
- [Firefox 147 版本 (Windows 10/11 x64)](https://static.clashpost.com/download/browser/Firefox_Windows_v147_x64_xMSRoI778Mjq0L1L.exe)
- [Firefox 147 版本 (Windows 10/11 arm64)](https://static.clashpost.com/download/browser/Firefox_Windows_v147_arm64_06NMvTbClhye1ZOt.exe)

注意：

- 以上链接仅适用于 64 位系统，32 位系统的用户请使用官方链接或寻找其他渠道。
- arm64 版本比较少见，通常只有当你在手机或平板电脑上安装了 Windows 才需要选择这个，一般情况下选择 x64 版本不会出错。
...
- [Chrome 109 版本 (Windows 7+)](https://static.clashpost.com/download/browser/Chrome_Windows_v109_BYbnCrpBIG5hsF5m.exe)
- [Firefox 115.32.0 ESR 版本 (Windows 7+)](https://static.clashpost.com/download/browser/Firefox_Windows_v115_32_esr_x64_TNPgaCsL0qSsbOrK.exe)
