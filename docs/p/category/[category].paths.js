export default {
    paths() {
        return [
            { params: { category: 'starter', categoryIndex: 1 }},
            { params: { category: 'advanced', categoryIndex: 2 }},
            { params: { category: 'knowledge', categoryIndex: 3 }},
            { params: { category: 'material', categoryIndex: 4 }},
