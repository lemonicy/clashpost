---
title: "游戏中出现过的障碍物一览"
description: "障碍物通常指树木、树干、岩石等不能随意移动的物体。。玩家可以花费少量资源移除障碍物，移除障碍物不需要空闲的工人，这个工作由村姑完成。如果你不小心让村姑去清除障碍物，则清除完成之前可以取消。取消清除障碍物返还全部资源，而取消升级建筑只返还 50%."
...
<PostHistory>
2025-08-08 修订：重写家乡障碍物的概述部分。<br>
2025-08-06 修订：将“装饰和障碍物的区别”拆分到另一篇文章，修复宝箱占地面积描述错误的问题。<br>
2025-08-05 修订：添加 13 周岁生日蛋糕。
</PostHistory>

**注意：**

- 如果你还不知道装饰和障碍物的区别，请移步：[如何区分装饰和障碍物？](/p/6993)
    - 根据这篇文章的定义，都城的花草树木都属于装饰，对此感兴趣的玩家请前往装饰页面查看。
- 本文的主题是障碍物，不是装饰，如想了解装饰相关的内容，请移步：[游戏中出现过的装饰一览](/p/1451)。
- 本文中的宝箱均指村庄中随机生成的障碍物，如想查看打开后奖励随机物品的箱子，请移步：[部落冲突竟然能开箱！你知道宝箱内有哪些奖励吗？](/p/6932)
...
- 障碍物通常指树木、树干、岩石等不能随意移动的物体。
- 玩家可以花费少量资源移除障碍物，**移除障碍物不需要空闲的工人**，这个工作由村姑完成。
    - 如果你不小心让村姑去清除障碍物，则清除完成之前可以取消。
    - 取消清除障碍物返还全部资源，而取消升级建筑只返还 50%.
- **树木被移除后可以重生，但岩石不可以。**
- 障碍物可以放到村庄的主游戏区域和阵型边缘。
- **障碍物的任何位置均可部署部队**，部队行进过程中会直接穿过障碍物。
- 您不能将建筑放置在障碍物上（夜世界的高草丛除外）。
- 虽然玩家可以避开障碍物放置建筑，但随着大本营等级的提高，建筑会越来越多。为了保证建筑有地方放，玩家需要移除障碍物、将其移到其他地方，或者将其藏起来。
- 如果对障碍物使用移位任意铲，该障碍物以后便可和装饰一样永久移动，也可以藏在村庄编辑模式的建筑栏中。
    - 用过铲子的障碍物仍然可以被移除，移除费用和没用过铲子的障碍物一样。
    - 移除障碍物不会补偿铲子的费用。
...
- 普通障碍物生长时需要有一格缓冲区，也就是说，障碍物和周围的建筑/城墙之间至少要有一格距离，而特殊障碍物没有这个限制。
  ...
  - 宝箱占地 2×2，而且生成宝箱不需要缓冲区，所以下图中 ① 和 ③ 的位置都可以生成宝箱。
...
- 根据 [这篇文章](/p/6993) 的定义，远古野蛮人雕像属于装饰，不属于障碍物，因此此处不列出。
