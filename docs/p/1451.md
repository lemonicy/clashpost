---
title: "游戏中出现过的装饰一览"
description: "装饰通常指旗子、雕像等用来美化村庄的物体。装饰对村庄没有加成，海盗旗和万能神像对村庄有加成的说法是谣言。和障碍物不同的是，玩家无法移除装饰。装饰可以放到村庄的主游戏区域和阵型边缘。装饰的任何位置均可部署部队，部队行进过程中会直接穿过装饰。"
module: posts-material
canonical: /p/1451
featuredImg: /p/1451/Deco_Concept_Art.jpg
authorId: coc-translator
lastCreated: 2020-05-09T21:41:41+08:00
lastUpdated: 2025-09-14T00:55:32+08:00
tags: decorations
...
<PostHistory>
2025-09-13 修订：添加速写召唤装饰，将特殊装饰按推出时间分类。<br>
2025-08-12 修订：添加 2025 年 8 月新增的装饰。<br>
2025-08-08 修订：重写家乡装饰的概述部分。<br>
</PostHistory>

**注意：**

- 如果你还不知道装饰和障碍物的区别，请移步：[如何区分装饰和障碍物？](/p/6993)
...
- 装饰通常指旗子、雕像等用来美化村庄的物体。
- **装饰对村庄没有加成**，海盗旗和万能神像对村庄有加成的说法是谣言。
- 和障碍物不同的是，玩家无法移除装饰。
- 装饰可以放到村庄的主游戏区域和阵型边缘。
- **装饰的任何位置均可部署部队**，部队行进过程中会直接穿过装饰。
- 您不能将建筑放置在装饰上。
- 虽然玩家可以避开装饰放置建筑，但随着大本营等级的提高，建筑会越来越多。为了保证建筑有地方放，玩家需要把装饰藏起来。
- 装饰可以直接隐藏，无需使用移位任意铲，隐藏之后您只需进入商店即可把隐藏的装饰重新放回村庄。
...
在说明一栏中，我们通常只记录装饰首次推出时的获取方式，不记录返场情况。
...
<Table class="cp-deco-table-container" maxWidth="850px">
    <table>
        ...
        <tr>
            ...
            <td class="cp-table-col-description">在 2023/11 推出，玩家可以 <a href="https://link.clashofclans.com/en/?action=voucher&code=68815144-e63a-4ed5-b224-457d7a92b470" target="_blank" rel="nofollow noopener noreferrer">点击指定的链接（已失效）</a> 领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
        ...
        <tr>
            ...
            <td class="cp-table-col-description">在 2023/12 的饼干大作战活动中获取 16 000 香甜圣水（任务点数）后可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
            ...
            <td class="cp-table-col-description">在 2023/12 的饼干大作战活动中购买活动令牌（你可以理解为第二月卡）并获取 7 000 香甜圣水（任务点数）购买。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
...
<Table class="cp-deco-table-container" maxWidth="850px">
    <table>
        ...
        <tr>
            ...
            <td class="cp-table-col-description">在 2024/02 的龙年佳节活动中获取 16 000 红包（任务点数）后可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
            ...
            <td class="cp-table-col-description">在 2024/02 的龙年佳节活动中购买活动令牌（第二月卡）并获取 7 000 红包（任务点数）后可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
        ...
        <tr>
            ...
            <td class="cp-table-col-description">在 2024/03 的超级飞龙大舞台活动中获取 10 000 冰块（任务点数）即可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
            ...
            <td class="cp-table-col-description">在 2024/03 的超级飞龙大舞台活动中购买活动令牌（第二月卡）并获取 5 550 冰块（任务点数）即可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
        ...
        <tr>
            ...
            <td class="cp-table-col-description">在 2024/04 的火箭气球兵大舞台活动中获取 10 000 冰块（任务点数）即可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
            ...
            <td class="cp-table-col-description">在 2024/04 的火箭气球兵大舞台活动中购买活动令牌（第二月卡）并获取 5 550 冰块（任务点数）即可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
        ...
        <tr>
            ...
            <td class="cp-table-col-description">在 2024/04 推出，玩家可以 <a href="https://link.clashofclans.com/cn/?action=voucher&code=c4fda901-9728-4a46-9486-a025f728ffb2">点击指定的链接（已失效）</a> 领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
        ...
        <tr>
            ...
            <td class="cp-table-col-description">在 2024/05 的并肩哈兰德活动中获取 16 000 足球（任务点数）即可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
            ...
            <td class="cp-table-col-description">在 2024/05 的并肩哈兰德活动中购买活动令牌（第二月卡）并获取 7 000 足球（任务点数）即可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
        ...
        <tr>
            ...
            <td class="cp-table-col-description">在 2024/06 的超级炸弹人大舞台活动中获取 10 000 冰块（任务点数）即可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
            ...
            <td class="cp-table-col-description">在 2024/06 的超级炸弹人大舞台活动中购买活动令牌（第二月卡）并获取 5 550 冰块（任务点数）即可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
        ...
        <tr>
            ...
            <td class="cp-table-col-description">在 2024/08 的动漫与部落活动中获取 16 000 魔法水晶（任务点数）即可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
        ...
        <tr>
            ...
            <td class="cp-table-col-description">在 2024/10 的合体狂热活动中获取 16 000 酸腐圣水（任务点数）后即可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
        ...
        <tr>
            ...
            <td class="cp-table-col-description">在 2024/11 的大闹玩具店活动中获取 16 000 齿轮（任务点数）后即可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
...
<Table class="cp-deco-table-container" maxWidth="850px">
    <table>
        ...
        <tr>
            ...
            <td class="cp-table-col-description">在 2025/02 的灵蛇庆典活动中获取 16 000 红灯笼（任务点数）后即可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
        ...
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/Shooting_Range.png" alt="射击场" width="157" height="211" />
            </td>
            <td class="cp-table-col-name">射击场</td>
            <td class="cp-table-col-description">2025/03/17 时在商店中以礼包的形式推出，售价 4.99 美元。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/Rumbling_Goblins.png" alt="乱斗哥布林" width="157" height="211" />
            </td>
            <td class="cp-table-col-name">乱斗哥布林</td>
            <td class="cp-table-col-description">在 2025/04 的是敌是友活动中获取 16 000 活动门票（任务点数）后即可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/Surprise_Wheel.png" alt="惊喜转盘" width="157" height="211" />
            </td>
            <td class="cp-table-col-name">惊喜转盘</td>
            <td class="cp-table-col-description">在 2025/04 的是敌是友活动中花费 3 100 冠军奖章（活动货币）购买。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/Golden_Giant.png" alt="黄金巨人" width="157" height="211" />
            </td>
            <td class="cp-table-col-name">黄金巨人</td>
            <td class="cp-table-col-description">在 2025/04 的是敌是友活动中花费 1 025 冠军奖章（活动货币）购买。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/WWE_Title.png" alt="WWE 冠军" width="198" height="206" />
            </td>
            <td class="cp-table-col-name">WWE 冠军</td>
            <td class="cp-table-col-description">在 2025/04 推出，是淘金狂潮活动的奖励，你需要与部落的小伙伴一起通过 <a href="/p/6463">联机模式</a>、收采集器、收 <a href="/p/1641">资源车</a> 这三种方式赚取金币，部落获得的金币数达到 16 亿即可领取该装饰。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/Creator_Fountain.png" alt="创作者喷泉" width="180" height="234" />
            </td>
            <td class="cp-table-col-name">创作者喷泉</td>
            <td class="cp-table-col-description">在 2025/05 推出，仅 Supercell 官方认证的创作者可拥有。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/Sacred_Gate.png" alt="神圣之门" width="190" height="269" />
            </td>
            <td class="cp-table-col-name">神圣之门</td>
            <td class="cp-table-col-description">在 2025/05 的迷你大舞台活动中花费 1 250 超级奖章（活动货币）购买。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/Looter_Wagon.png" alt="战利品货车" width="247" height="201" />
            </td>
            <td class="cp-table-col-name">战利品货车</td>
            <td class="cp-table-col-description">在 2025/06 的黑暗交易活动中获取 16 000 活动门票（任务点数）后即可领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/Jingle_Maker.png" alt="魔音制造机" width="280" height="291" />
            </td>
            <td class="cp-table-col-name">魔音制造机</td>
            <td class="cp-table-col-description">2025/06/18 ~ 07/01 期间可在商店中购买，售价 4.99 美元。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/Justice_Crown.png" alt="正义皇冠" width="139" height="164" />
            </td>
            <td class="cp-table-col-name">正义皇冠</td>
            <td class="cp-table-col-description">在 2025/06 推出，玩家可以 <a href="https://link.clashofclans.com/?action=voucher&code=2b384f2d-cf45-4ad8-aa03-c181615f6946" target="_blank" rel="nofollow noopener noreferrer">点击指定的链接（已失效）</a> 领取。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/Cyber_Hologram.png" alt="赛博全息" width="134" height="211" />
            </td>
            <td class="cp-table-col-name">赛博全息</td>
            <td class="cp-table-col-description">2025/07/14 ~ 08/01 期间可在商店中购买，售价 4.99 美元。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/Party_Bench.png" alt="派对长凳" width="199" height="177" />
            </td>
            <td class="cp-table-col-name">派对长凳</td>
            <td class="cp-table-col-description">在 2025/08 的水花大赛活动中获取 16 000 凤凰泳圈（任务点数）购买。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/Clashy_Carving.png" alt="部落雕刻" width="201" height="224" />
            </td>
            <td class="cp-table-col-name">部落雕刻</td>
            <td class="cp-table-col-description">在 2025/08 的水花大赛活动中花费 3 100 水花奖章（活动货币）购买。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/Frozen_Wizard.png" alt="冰冻法师" width="151" height="240" />
            </td>
            <td class="cp-table-col-name">冰冻法师</td>
            <td class="cp-table-col-description">在 2025/08 的水花大赛活动中花费 1 025 水花奖章（活动货币）购买。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/Soda_Stand.png" alt="苏打汽水摊" width="201" height="171" />
            </td>
            <td class="cp-table-col-name">苏打汽水摊</td>
            <td class="cp-table-col-description">在 2025/08 的水花大赛活动中花费 1 025 水花奖章（活动货币）购买。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        <tr>
            <td class="cp-table-col-icon">
                <Pic src="/p/1451/Sketch_Summoner.png" alt="速写召唤" width="201" height="171" />
            </td>
            <td class="cp-table-col-name">速写召唤</td>
            <td class="cp-table-col-description">在 2025/09 的迷你大舞台活动中花费 1 600 超级奖章（活动货币）购买。</td>
            <td class="cp-table-col-numeric">1</td>
        </tr>
        </tbody>
    </table>
...
以下装饰存在于游戏文件中，无法通过正常方式获取。它们偶尔会出现在官方创作中，比如赛季宣传视频、进攻挑战等。

<DecoImgGroup>
    <DecoImg src="/p/1451/Goblin_Cart.png" caption="哥布林小车" width="170" height="145" />
    <DecoImg src="/p/1451/Goblin_Chest.png" caption="哥布林宝箱" width="203" height="180" />
    <DecoImg src="/p/1451/Goblin_Barrel.png" caption="哥布林飞桶" width="90" height="92" />
    <DecoImg src="/p/1451/Unnamed_Fountain_Decoration.png" caption="无名喷泉" width="250" height="325" style="font-style: italic" />
    <DecoImg src="/p/1451/Razer_Deco.png" caption="雷蛇装饰" width="179" height="136" />
    <DecoImg src="/p/1451/Flexing_Barbarian.png" caption="肌肉野蛮人" width="124" height="198" />
    <DecoImg src="/p/1451/League_Hammer.png" caption="联赛战锤" width="180" height="185" />
    <DecoImg src="/p/1451/League_Shield.png" caption="联赛护盾" width="255" height="238" />
    <DecoImg src="/p/1451/Beach_Break.png" caption="海岛假期" width="151" height="114" />
    <DecoImg src="/p/1451/Heroic_Chicken.png" caption="英雄母鸡" width="116" height="142" />
    <DecoImg src="/p/1451/Festival_Lantern.png" caption="节日彩绘灯" width="169" height="158" />
</DecoImgGroup>
...
- 在夜世界，除远古野蛮人雕像的大小是 3×3 外，其余装饰都是 2×2.
    - 古老野蛮人雕像的大小也是 3×3，但根据 [这篇文章](/p/6993) 的定义，它不属于装饰，而属于障碍物。
- 其余同家乡部分。
...
- 都城的装饰和家乡、夜世界的不太一样，都城的装饰同时具有建筑、障碍物和装饰的一部分特征。
    ...
    - 它们在重建完成后可以在编辑阵型时移动，这是其装饰的特征。
    - 虽然说它们同时含有建筑、障碍物和装饰的特征，但我们最终决定将它们称为装饰，或许可以叫都城特色的装饰。
    - 都城的墓碑可以被重建，和都城的其他装饰一样，所以我们将都城的墓碑也归入了装饰一类，而家乡和夜世界的墓碑仍然属于障碍物。我不知道这样归类是否方便，但总得有个分类对吧……
- 和家乡和世界不同的是，虽然你可以在都城的装饰上部署部队，但部队在行进过程中会绕过装饰，而非直接穿过。
...
- 本文内容翻译自 [Decorations | Clash of Clans Wiki | Fandom](https://clashofclans.fandom.com/wiki/Decorations)，感谢 Clash of Clans Wiki 提供的信息。
- 本文封面图取自 Dom Clubb，原链接：[Dom Clubb - Clash of Clans Olympic theme concept art](https://deadwood.games/projects/6LnwRx).