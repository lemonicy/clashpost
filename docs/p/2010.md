...
canonical: /p/2010
featuredImg: /p/2010/Map_Mash-A-Rama_thumb.jpg
authorId: coc-translator
lastCreated: 2020-05-09T21:41:41+08:00
lastUpdated: 2025-09-04T18:59:09+08:00
tags: scenery
...
<PostHistory>
2025-09-04 修订：添加 Mash-A-Rama 场景。<br>
...
**下载地址**：<a href="https://static.clashpost.com/p/2010/部落冲突村庄场景_20250904.zip">部落冲突村庄场景_20250904.zip</a>  
**文件大小**：227 MB

## 最新场景（点击可查看原图）

<a href="https://static.clashpost.com/p/2010/Map_Mash-A-Rama.jpg" target="_blank">
    <Pic src="/p/2010/Map_Mash-A-Rama_show.jpg" caption="Mash-A-Rama" width="1500" height="1000" />
</a>

## 注意事项

- 下载地址中只包含场景图片，不包含场景图标、船只、飞空艇、铸币坊等场景组件，也不包含场景的背景音乐。
- 文章中的图片有裁剪或压缩，如想保存原图，请点击场景图片查看原图，或直接下载打包文件，。
...
- [分服](/p/2754) 后，海盗基地场景的名称改为海上基地，本文采用旧称。
...
<Table class="cp-scenery-table" maxWidth="800px">
    <table>
        ...
        <tr>
            <td>Mash-A-Rama</td>
            <td class="cp-scenery-col-icon">
                <Pic src="/p/2010/Scenery_Mash-A-Rama_thumb.png" alt="" width="240" height="294" />
            </td>
            <td class="cp-scenery-col-img">
                <a href="https://static.clashpost.com/p/2010/Map_Mash-A-Rama.jpg" target="_blank">
                    <Pic src="/p/2010/Map_Mash-A-Rama_thumb.jpg" alt="" width="480" height="320" />
                </a>
            </td>
...
<Table class="cp-scenery-table" maxWidth="750px">
    <table>
        ...
        <tr>
            <td>Mash-A-Rama</td>
            <td class="cp-scenery-col-components">
                <Pic src="/p/2010/Boat_Normal_Mash-A-Rama.png" alt="" width="170" height="154" />
            </td>
            <td class="cp-scenery-col-components">
                <Pic src="/p/2010/Boat_Broken_Mash-A-Rama.png" alt="" width="255" height="224" />
            </td>
            <td class="cp-scenery-col-components">
                <Pic src="/p/2010/Boat_BB_Mash-A-Rama.png" alt="" width="105" height="148" />
            </td>
        </tr>
        <tr>
            <td>水晶洞穴<br>(夜世界)</td>
...
<Table class="cp-scenery-table" maxWidth="750px">
    <table>
        ...
        <tr>
            <td>Mash-A-Rama</td>
            <td class="cp-scenery-col-components">
                <Pic src="/p/2010/Airship_Mash-A-Rama.png" width="288" height="302" />
            </td>
            <td class="cp-scenery-col-components">无</td>
            <td class="cp-scenery-col-components">
                <Pic src="/p/2010/Forge_Mash-A-Rama.png" width="283" height="366" />
            </td>
        </tr>
        </tbody>
    </table>
...
<Table class="cp-scenery-table" maxWidth="750px">
    <table>
        ...
        <tr>
            <td>Mash-A-Rama</td>
            <td class="cp-scenery-col-components">
                <Pic src="/p/2010/Trader_Mash-A-Rama.png" width="193" height="155" />
            </td>
            <td class="cp-scenery-col-components">
                <Pic src="/p/2010/Sauna_Mash-A-Rama.png" width="207" height="170" />
            </td>
        </tr>
        </tbody>
    </table>
...
我们没有将这部分内容搬过来的打算，请前往 [英文维基的配乐页面](https://clashofclans.fandom.com/wiki/Soundtrack#Scenery_Music) 查看。
