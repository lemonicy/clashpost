...
2025-07-26 修订：添加 2025 年 5 - 7 月的村庄场景。<br>
2025-04-17 修订：补充埃及古迹以后推出的场景的高级特性，添加场景系统更新历史以及两个场景的早期设计。
</PostHistory>
...
**下载地址**：<a href="https://static.clashpost.com/p/2010/部落冲突村庄场景_20250805.zip">部落冲突村庄场景_20250805.zip</a>  
**文件大小**：213 MB
...
1. 老版本部落冲突曾经采用的场景，但已不再使用。
2. 游戏文件中曾经存在的场景，但最终没有采用。
...
- 2024/09/09 更新新增了传奇场景的概念，并于第二个月发布第一个传奇场景——飞龙领地。
...
/* 给传奇场景添加紫色效果 */
.cp-scenery-legendary {
    color: var(--cp-legendary-color-light);
}

.cp-theme-dark .cp-scenery-legendary {
    color: var(--cp-legendary-color-dark);
}
</style>