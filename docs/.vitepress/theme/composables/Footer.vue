<template>
    <div id="cp-footer">
        Copyright © 2018-2026 部落驿站（原部落冲突指导）<br>
        <a href="/p/260">用户须知</a> | <a href="https://github.com/lemonicy/clashpost" target="_blank" rel="nofollow noreferrer noopener">Github 开源地址</a> | <a href="/faq">联系我们</a><br>
